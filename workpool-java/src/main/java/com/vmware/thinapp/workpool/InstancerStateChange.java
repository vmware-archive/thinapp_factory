...
public class InstancerStateChange extends StateChange<Instancer.State, Instancer> {
   /**
    * Constructor
    *
    ...
    */
   public InstancerStateChange(Instancer.State previousState, Instancer.State newState, Instancer sender) {
