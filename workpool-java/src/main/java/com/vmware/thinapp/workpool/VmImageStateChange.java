...
public class VmImageStateChange extends StateChange<VmImageModel.State, VmImageInstance> {
   /**
    * Constructor
    *
    ...
    */
   public VmImageStateChange(VmImageModel.State previousState, VmImageModel.State newState, VmImageInstance sender) {
