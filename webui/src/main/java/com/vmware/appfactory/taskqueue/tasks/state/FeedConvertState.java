...
/**
 * A snapshot of the status of a FeedConvertTask.
 */
public interface FeedConvertState
      extends AbstractFeedState<FeedConvertState,
                                FeedConvertState.Builder,
                                FeedConvertState.FeedConvertStatus> {

   String TYPE = "FEED_CONVERT";

   enum FeedConvertStatus {
      waiting,
      comparing,
      queueing,
      complete,
   ...
   public class Builder
         extends AbstractFeedStateBuilder<FeedConvertState,Builder,FeedConvertStatus> {
   ...
   public class Impl
         extends AbstractFeedStateImpl<FeedConvertState,Builder,FeedConvertStatus>
         implements FeedConvertState {
      @Nonnull
      @Override
