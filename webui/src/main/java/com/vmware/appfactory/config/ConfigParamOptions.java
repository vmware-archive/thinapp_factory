...
/**
 * AfConfigParam instances that are of type SINGLE_SELECT may implement
 * one of these to provide the current set of allowed values.
 */
public interface ConfigParamOptions
{
   /**
